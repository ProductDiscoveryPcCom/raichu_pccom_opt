...
PREGUNTAS_UNIVERSALES = [
    ...
    "¿Hay productos específicos de PcComponentes que DEBEN incluirse? (pega URLs o nombres)",
...
ARQUETIPOS: Dict[str, Dict[str, Any]] = {
    ...
    "ARQ-4": {
        ...
        "guiding_questions": [
            ...
            "¿Se ha probado el producto realmente? ¿Durante cuánto tiempo?",
            "¿Cuáles son las 3-5 especificaciones MÁS importantes para el comprador?",
            "¿Cuáles son los 3 puntos FUERTES principales? (basados en uso real o reviews)",
            "¿Cuáles son los 2-3 puntos DÉBILES o 'peros'? (ser honestos)",
            "¿Contra qué 2-3 productos compite directamente? (URLs de PcC)",
            "¿Para qué TIPO de usuario es ideal y para cuál NO lo es?",
            "¿Hay datos de benchmarks, tests o pruebas de rendimiento?",
    ...
    "ARQ-5": {
        ...
        "guiding_questions": [
            ...
            "¿Hay un ganador claro o depende totalmente del caso de uso?",
    ...
    "ARQ-7": {
        ...
        "guiding_questions": [
            ...
            "¿Hay productos que la gente busca pero NO recomendamos? ¿Por qué?"
        ],
        "default_length": 2200,
        "min_length": 1500,
        "max_length": 4000,
    ...
    "ARQ-17": {
        ...
        "guiding_questions": [
            ...
            "¿El usuario debería esperar o comprar ahora?"
        ],
        "default_length": 1600,
        "min_length": 1000,
        "max_length": 2400,
    ...
    "ARQ-22": {
        ...
        "guiding_questions": [
            ...
            "¿Qué hardware REAL consigue 60fps estables en cada calidad? (basado en benchmarks)",
