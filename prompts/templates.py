...
# Template para estructura HTML
HTML_STRUCTURE_TEMPLATE = SafeTemplate("""
<article class="content-seo">
    <!-- Kicker opcional -->
    <p class="kicker">$kicker_text</p>
...
# Template para tabla comparativa
COMPARISON_TABLE_TEMPLATE = SafeTemplate("""
<div class="lt cols-$num_columns">
    <table>
        <thead>
            <tr>
                $header_cells
...
# Template para grid de productos
PRODUCT_GRID_TEMPLATE = SafeTemplate("""
<div class="grid cols-$num_columns">
    $product_cards
</div>
""", name="product_grid")


# Template para card de producto
PRODUCT_CARD_TEMPLATE = SafeTemplate("""
<div class="card">
    <h3>$product_name</h3>
    ...
    <a href="$product_url" class="btn primary">$cta_text</a>
</div>
""", name="product_card")
...
- Estructura semántica: article > h1 > sections con h2/h3
...
def _register_all_templates():
    ...
    templates = [
        ...
        ("comparison_table", COMPARISON_TABLE_TEMPLATE._raw),
        ("product_grid", PRODUCT_GRID_TEMPLATE._raw),
        ("product_card", PRODUCT_CARD_TEMPLATE._raw),
    ]
